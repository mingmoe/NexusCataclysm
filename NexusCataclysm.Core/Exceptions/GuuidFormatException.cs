...
{
    public GuuidFormatException()
        : this("unknown")
    {
    }

    public GuuidFormatException(string guuid)
        : this(guuid, null, null)
    {
    }

    public GuuidFormatException(string guuid, Exception? exception)
        : this(guuid, null, exception)
    {
    }

    public GuuidFormatException(string guuid, string? reason, Exception? exception)
        : base(
